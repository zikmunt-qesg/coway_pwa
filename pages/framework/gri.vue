    ...
    return {
      ...
      gri_table_400: [
        ...
        },
        {
          ...
          link: ['/static_page/임직원-중심의-기업문화와-안전한-근무환경#산업안전보건위원회운영'],
          Note: ''
        },
        {
          classification: '산업안전보건',
        ...
        },
        {
          ...
          link: ['/static_page/임직원-중심의-기업문화와-안전한-근무환경#직무교육'],
          Note: ''
        },
        {
          classification: '훈련 및 교육',
        ...
        },
        {
          ...
          link: ['/static_page/인권-리포트#핵심적인권요소에대한조치결과'],
          Note: ''
        },
        {
        ...
        },
        {
          ...
          link: ['/static_page/협력회사-CSR-리포트#공급망지속가능성사전스크리닝'],
          Note: ''
        },
        {
          classification: '공급망 관리',
        ...
        },
        {
          ...
          link: ['/static_page/제품-책임#안전인증확대및고객안심'],
          Note: ''
        },
        {
          classification: '고객 안전보건',
