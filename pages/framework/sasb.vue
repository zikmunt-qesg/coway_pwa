<template>
  <div>
    <b-container>
    <search-form class="my-3" prop_mode='indicator' prop_framework='SASB'></search-form>
    ...
    <h7 class="mb-2">가전제품 제조(Appliance Manufacturing) 지속가능성 지표</h7>
    ...
    <h7 class="mb-2">가전제품 제조(Appliance Manufacturing) 활동 지표</h7>
    <b-table-simple class="num-table" responsive>
      <b-thead>
        <b-tr>
          <b-td>구분</b-td>
    ...
    <h7 class="mb-2">전문 및 상업 서비스(Professional and Commercial Service) 지속가능성 지표</h7>
    <b-table-simple class="num-table" responsive>
      <b-thead>
        <b-tr>
          <b-td>구분</b-td>
    ...
    <h7 class="mb-2">전문 및 상업 서비스(Professional and Commercial Service) 활동 지표</h7>
    <b-table-simple class="num-table" responsive>
      <b-thead>
        <b-tr>
          <b-td>구분</b-td>
