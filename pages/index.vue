...
<div class="position-relative min-vh-100">
    ...
    <b-container>
        <hr class="mb-4">
        <h1 class="text-center mb-3 fw-400"> SUSTAINABILITY ISSUES <span style="font-family:'Noto Sans KR'"> 2019 </span></h1>
        <section>
            <b-row class="mb-4">
                <b-col class="col-0 col-md-1"></b-col>
                <b-col class="col-12 col-md-10 text-center mb-4 f-105 letter-narrow gray6">
        ...
        <hr class="mb-5">
        <h1 class="text-center mb-3 fw-400"> KEY FIGURES <span style="font-family:'Noto Sans KR'">2019</span></h1>
        <section>
            <b-row class="mb-4">
                <b-col class="col-0 col-md-1"></b-col>
                <b-col class="col-12 col-md-10 text-center letter-narrow f-105 mb-4 gray6">
                    물과 공기를 다루는 업이 생명과 직결되는 만큼, 우리가 하는 일에 책임을 다하는 것에서 코웨이의 지속가능경영은 시작합니다.<br> 
                    코웨이는 제품 및 서비스 개발, 생산, 마케팅, 판매에 이르기까지 비즈니스 전 과정에서 지속가능성을 추구하기 위해 노력하고 있습니다.<br> 2019년 코웨이의 경제, 환경, 사회 관련 주요 성과 지표를 한 눈에 볼 수 있습니다. 
                </b-col>
                <b-col class="col-0 col-md-1"></b-col>
            </b-row>
            ...
            <b-row class="my-4">
                <b-col class="col-12 col-md-4 border-right-gray-bold">
                    ...
                    <div class="d-flex align-items-center gray5 f-80 position-relative"><div class="bg-gray3" style="height:16px; width:41%;"></div> 
                        <div class="position-absolute" style="top:4px; left:5px;">2018</div><div class="ml-2 d-flex align-items-center"> <span class="f-110"> 25,168 </span> 억원 </div>
                    </div>
                    <div class="d-flex align-items-center blue7 f-80 position-relative"><div style="height:16px; width:70%; background-color:#1494d4;"></div> 
                        <div class="position-absolute text-white" style="top:7px; left:5px;">2019</div><div class="ml-2 d-flex align-items-center"> <span class="f-140"> 30,189 </span> 억원 </div>
                    </div>
                </b-col>
                <b-col class="col-12 col-md-4 border-right-gray-bold">
            ...
            <b-row class="my-4">
                ...
                <b-col class="col-12 col-md-4">
                    <div class="blue7 mb-5 f-105 fw-500"> 협력사 상생 활동</div>
                    <div class="blue7 f-120"> 코웨이는 협력사와의 긴밀한 협력과 상생활동을 추진하여 산업 내 건강한 거래문화를 견인하고자 합니다.<br> 협력사와 열린 소통을 추진하여 경영안정 기반 강화, 성장 인프라 지원 등 다각적인 동반성장 활동을 추진합니다. 
                    </div>
                </b-col>
            </b-row>
            <div class="col-12 bg-gray3 f-105 fw-500 py-2 px-3"> Environmental Performance </div>
            <b-row class="my-4">
                <b-col class="col-12 col-md-4 border-right-gray-bold">
                    <div class="blue7 f-105 fw-500 mb-2"> 친환경 제품 개발 </div>
                    <div class="gray67 f-105 mb-5"> 코웨이는 제품개발 프로세스, 청정생산, 렌탈 서비스, 회수 및 재활용에 이르는 전 과정에서 부정적 환경영향을 줄이는 친환경적 비즈니스를 설계합니다.  
                    </div>
                    <div class="d-flex justify-content-between align-items-center">                
                ...
                <b-col class="col-12 col-md-4 border-right-gray-bold">
                    <div class="blue7 mb-45"> 2010년 온실가스 원단위 0.357톤CO2e/억원 대비 2019년 원단위 0.233톤CO2e/억원으로 매출 증가 대비 온실가스 배출량을 최대한 억제하여 목표 대비 약 70% 저감했습니다. 2020년 이후 과학적 감축 목표 계획에 근거하여 2050년까 중장기 목표를 수립하고 있습니다. 
                    </div>
                    <div class="d-flex justify-content-between align-items-end">                
                        <div class="local-temp-circle rounded-circle bg-gray3 position-relative">
                            <div class="position-absolute text-center w-100 mt-2">
                                <div class="gray63 fw-600 f-90">2017</div><div class="blue7 mb-m-2 f-190">0.232</div><div class="gray63 f-90 fw-300">tCO<span class="f-60">2</span>e/억원</div>
                            </div>
                        </div>
                        <div class="local-temp-circle rounded-circle bg-gray3 position-relative">
                            <div class="position-absolute text-center w-100 mt-2">
                                <div class="gray63 fw-600 f-90">2018</div><div class="blue7 mb-m-2 f-190">0.252</div><div class="gray63 f-90 fw-300">tCO<span class="f-60">2</span>e/억원</div>
                            </div>
                        </div>
                        <div class="local-temp-circle rounded-circle position-relative" style="background-color: #1494d4">
                            <div class="position-absolute text-center w-100 mt-2">
                                <div class="gray63 fw-600 f-90">2019</div><div class="text-white mb-m-2 f-190">0.232</div><div class="text-white f-80 fw-300">tCO<span class="f-60">2</span>e/억원</div>
                            </div>
                        </div>
                    </div>
                </b-col>    
        ...
        <h1 class="text-center mb-3 fw-400"> SUSTAINABILITY NEWS</h1>
        <b-row class="mb-3">
            <b-col class="col-0 col-md-1"></b-col>
            <b-col class="col-12 col-md-10 text-center gray6 letter-narrow f-105 mb-4">주요 이해관계자와 함께 새로운 가치를 더하기 위한 코웨이의 노력, 지속가능성 관련 소식을 여기서 만나볼 수 있습니다
            </b-col>
            <b-col class="col-0 col-md-1"></b-col>
        </b-row>
        <b-row>
