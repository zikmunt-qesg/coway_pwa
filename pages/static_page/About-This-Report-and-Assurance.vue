            ...
            <b-col class="col-12 col-lg-10 px-0">
                <b-card v-if="show_page=='About-This-Report'" class="border-0 px-4 py-5 fw-400">
                    <div class="px-md-2 px-lg-4 atr-content">
                        ...
                        <p class="mb-45">서울 사무소, 연구소, 생산본부를 중심으로 작성하였으며, 이 보고 범위는 매출액 기준 90%이상에 해당합니다. 일부 성과는 글로벌 사업 현황을 포함하였습니다. 재무데이터는 연결실적 기준입니다.
                        </p>
                        ...
                        <p class="mb-45">본 보고서에 담긴 재무정보는 독립 감사법인의 회계감사를 통해 작성되었으며, 비재무 정보는 보고 내용의 정확성과 신뢰성을 높이기 위하여 독립적 전문기관인 QESG(퀀티파이드이에스지)로부터 검증을 받았습니다. 
                        </p>
