    ...
    <b-container class="">
        ...
        <b-row>
            ...
            <b-container class="px-0">
                ...
                <!-- End of DMA-->
                <section class="mb-5">
                    <div class="d-flex mb-3 position-relative overflow-hidden"> <h6-ancor hash="s1" :activated="activated" class="gold7 f-130 fw-500 bg-white pr-5" style="z-index:10">코웨이다운 사회공헌</h6-ancor><div class="horizontal-line-2 gold-line position-absolute" style="z-index:8"></div></div>
                    ...
                    <hr class="py-3">
                    <h6-ancor hash="s1-1" :activated="activated" class="gold6 fw-500 mb-3 f-110">임직원과 함께하는 나눔 실천</h6-ancor>
                    ...
                    <hr class="py-3">
                    <div class="d-flex mb-3 position-relative overflow-hidden"> <h6-ancor hash="s2" :activated="activated" class="gold7 f-130 fw-500 bg-white pr-5" style="z-index:10">깨끗한 물과 공기를 위한 코웨이의 약속</h6-ancor><div class="horizontal-line-2 gold-line position-absolute" style="z-index:8"></div></div>
                ...
                <section class="bg-blue-gray1 py-4 px-4 mb-5">
                    <div class="d-flex justify-content-between mb-3 mt-2">
                        <h6-ancor hash="s2-1" :activated="activated" class="gold8 fw-500 mb-3 f-110 font-noto">'약속 1.물 - 지역사회 깨끗한 물 지원'</h6-ancor>
                    ...
                    <p class="f-105 mb-3">6.1 모두가 이용 가능한 안전한 식수에 대한 접근성 확보</p>
                        <b-table-simple responsive class="txt-table social-table f-90 mb-5">
                            ...
                            <b-tbody>
                                <b-tr><b-td style="width:33.3%">착한정수기 사업</b-td><b-td style="width:33.3%">안심지하수 사업</b-td><b-td>말레시이사 빗물공급장치 지원</b-td></b-tr>
                                <b-tr>
                                    ...
                                    <b-td class="word-break fw-300">
                                        2015년 환경부와 ‘안심 지하수 지원사업’ 협약을 체결하여 농촌 지하수 오염 지역에 정수기를 지원하고 있습니다. 지하수 오염 지역 주민들이 안심하고 깨끗한 물을 마실 수 있도록 약 500가구에 정수기를 무상으로 지원하고 있으며, 지하수 개선을 위한 기술 지원과 연구도 추진하고 있습니다. 
                                    </b-td>
                                    <b-td class="word-break fw-300">
                                        코웨이는 2018년부터 코웨이 말레이시아 현지 법인과 함께 물 취약지역을 선정하여 빗물공급장치를 지원하고 있습니다. 2019년 말 누적 155가구에 빗물공급장치를 기증하였으며, 202X년까지 1,000가구에 빗물공급장치를 제공하여 깨끗한 물에 대한 접근성을 확대할 계획입니다.
                                    </b-td> 
                                </b-tr>
                                <b-tr>
                    ...
                    <hr class="py-2">
                    <div class="d-flex justify-content-between mb-3 mt-2">
                        <h6-ancor hash="s2-2" :activated="activated" class="gold8 fw-500 mb-3 f-110 font-noto">'약속 2.공기 - 취약계층 환경개선 지원'</h6-ancor>
                    ...
                    <p class="f-105 mb-3">3.9 대기, 수질, 토양오염 및 유해 화학물질 등으로 인한 질병 및 사망 감축</p>
                        <b-table-simple responsive class="txt-table social-table f-90 mb-5">
                            ...
                            <b-tbody>
                                ...
                                <b-tr><b-td class="fw-300">대기오염과 미세먼지 증가에도 생활환경 개선이 어려운 취약계층을 돕고자 2018년 환경부와 ‘취약계층 환경성 질환 예방사업’ 업무 협약을 기반으로 공기청정기를 무상 지원하고 있습니다. 2019년 말 기준 서울을 포함한 수도권과 5대 광역시 등 지방자치단체 50곳에 총 400대의 공기청정기를 무상 지원하고, 관리 서비스를 제공하여 취약계층 거주 공간의 환경 개선을 돕고 있습니다.
                                </b-td></b-tr>
                                <b-tr>
                                    <b-td colspan="3" class="border-bottom-0">&nbsp;</b-td>
                                </b-tr>
                    ...
                    <hr class="py-2">
                    <div class="d-flex justify-content-between mb-3 mt-2">
                        <h6-ancor hash="s2-3" :activated="activated" class="gold8 fw-500 mb-3 f-110 font-noto">'약속 3.사람 - 청년 창업 지원'</h6-ancor>
                    ...
                    <b-table-simple responsive class="txt-table social-table f-90">
                        ...
                        <b-tbody>
                            ...
                            <b-tr><b-td class="fw-300">코웨이는 코디, CS닥터, 홈케어닥터, HP, 파랑새, BP 등 약 2만여 명의 1인 기업가가 활약하고 있는 '1인 기업’의 대표적인 파트너입니다. 코웨이는 라이프스타일 분야 관련 1인 창업을 준비하는 청년들을 지원하기 위해 창업사관학교 위스쿨(Wi School)을 운영하고 있습니다. 위스쿨은 비즈니스 모델 멘토링, 경영 컨설팅, 해외진출지원 등을 지원하여 전문적이고 실질적인 도움을 주고 있습니다. 2019년 코웨이는 위스쿨을 통해 총 2,300여 명의 청년 창업자를 지원하였으며, 30개 팀에 코웨이 멘토링 과정을 제공하였습니다.
                            </b-td></b-tr>
                            <b-tr>
                                <b-td colspan="3" class="border-bottom-0">&nbsp;</b-td>
                            </b-tr>
                ...
                <hr class="py-3">
                    <div class="d-flex mb-3 position-relative overflow-hidden"> <h6-ancor hash="s3" :activated="activated" class="gold7 f-130 fw-500 bg-white pr-5" style="z-index:10">공공정책 참여</h6-ancor><div class="horizontal-line-2 gold-line position-absolute" style="z-index:8"></div></div>
