...
<div class="position-relative page-top-bg-sus min-vh-100">   
    ...
    <div class="w-100 position-absolute bg-white" style="height:90.7%; top:600px; z-index:0"></div>
        ...
        <b-row>
            ...
            <b-container class="px-0">
                <section class="bg-white px-4 py-4">
                    ...
                    <h6-ancor :title="'조세 납부 현황 및 유효세율 보고'" :activated="activated" class="parang6 fw-500 mb-3">조세 납부 현황 및 유효세율 보고</h6-ancor>
