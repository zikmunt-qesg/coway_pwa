        ...
        <b-row>
            ...
            <b-container class="px-0">
                <section class="bg-white px-4 py-4 mb-5">
                    ...
                    <div class="d-flex mb-3 position-relative overflow-hidden"> <h6-ancor hash="s1" :activated="activated" class="parang7 f-130 fw-500 bg-white pr-5" style="z-index:10">윤리강령(Code of Conduct)</h6-ancor><div class="horizontal-line-2 parang-line position-absolute" style="z-index:8"></div></div>
                    ...
                    <div class="d-flex mb-3 position-relative overflow-hidden"><h6-ancor hash="s2" :activated="activated" class="parang7 f-130 fw-500 bg-white pr-5" style="z-index:10">윤리진단(Compliance Check Organization)</h6-ancor><div class="horizontal-line-2 parang-line position-absolute" style="z-index:8"></div></div>
                    ...
                    <div class="d-flex mb-3 position-relative overflow-hidden"><h6-ancor hash="s3" :activated="activated" class="parang7 f-130 fw-500 bg-white pr-5" style="z-index:10">윤리교육(Consensus by Ethic Education)</h6-ancor><div class="horizontal-line-2 parang-line position-absolute" style="z-index:8"></div></div>
