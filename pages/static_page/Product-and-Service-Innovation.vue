    ...
    <b-container v-else class="">
        ...
        <b-row class="px-lg-3">
            ...
            <b-container class="px-0 eng-font-scale">
                ...
                <h6-ancor hash="a3-1" :activated="activated" class="blue5 mb-3">Water Taste Evaluation & Research Lab</h6-ancor>
