        ...
        <b-row>
            ...
            <b-container class="px-0">
                <section class="bg-white px-4 py-4">
                    ...
                    <div class="d-flex mb-2 position-relative overflow-hidden"> <h6-ancor hash="s1" :activated="activated" class="gold7 f-130 fw-500 bg-white pr-5" style="z-index:10">인권 경영 원칙 및 가이드</h6-ancor></div>
                    ...
                    <div class="d-flex mb-3 position-relative overflow-hidden"> <h6-ancor hash="s2" :activated="activated" class="gold7 f-130 fw-500 bg-white pr-5" style="z-index:10">인권 리스크 식별 및 완화 프로세스</h6-ancor><div class="horizontal-line-2 gold-line position-absolute" style="z-index:8"></div></div>
                    <h6-ancor hash="s2-1" :activated="activated" class="gold6 fw-500 mb-2">리스크 식별 </h6-ancor>
                    ...
                    <h6-ancor hash="s2-2" :activated="activated" class="gold6 fw-500 mb-2">핵심적 인권 요소에 대한 조치 결과</h6-ancor>
