        ...
        <b-row class="px-lg-3">
            ...
            <b-container class="px-0">
                ...
                <hr class="mb-4">
                    ...
                    <p class="mb-5">개인정보 침해사고 발생 시 신속한 초기 대응을 통해 피해를 최소화하고 추가적 피해가 없도록 사고 대응 체계를 구축하여 관련 부서에 정기적으로 배포 및 교육하고 있습니다. 우선 사고인지 즉시 정보보호전담부서(보안팀) 및 정보보호책임자에 보안사고 의심 내역을 신고하고, 사고대응팀을 구성합니다. 다음으로 1차 초동조치, 2차 원인분석, 3차 문제해결, 4차 사후조치의 4단계 사고대응 프로세스를 추진하며, 관련 신고 기관에 현황을 보고합니다. 마지막으로 재발방지대책을 수립 및 적용 후 모니터링하며 사후 관리를 진행합니다. 
                    </p>
                    <b-table-simple responsive class="txt-table f-95 fw-300 mb-5">
                        ...
                        <b-tbody>
                            <b-tr>
                                <b-td rowspan="2">사고인지</b-td><b-td>보안사고 발생통지</b-td><b-td><p class="indent mb-0">&#9312; 사고발생 인지부서 : 정보보호관리자에게 보안사고 의심내용 신고</p><p class="indent mb-0">&#9313; 정보보호부서(보안팀) : 보안사고 원인 파악</p></b-td>
                            </b-tr>
                            <b-tr>
