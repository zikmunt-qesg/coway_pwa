                    ...
                    <div class="border-top-bottom-dark">
                        <b-row no-gutters class="px-3 pt-4">                            
                            <b-col class="col-12 col-sm-4 mb-2 mb-sm-0 fw-500 gold8">
                                ...
                                <h4-ancor :title="'라이프케어 전문 파트너 양성'" :activated="activated" class="mb-4 mb-sm-5 mt-m-2">라이프케어 전문 파트너 양성</h4-ancor>
                            </b-col>
                        </b-row>
                        ...
                        <b-row no-gutters class="px-3 py-3 border-top-dark">
                            <b-col class="col-12 col-md-7 pr-md-4 mb-4 mb-md-0">
                                ...
                                <b-row no-gutters> 
                                    ...
                                    <b-col class="col-4 text-center fw-500"><div class="temp-icon2 mx-auto mb-3"><b-img src="@/assets/images/구성 요소10_1.svg" fluid class="h-100"></b-img></div>
                                        <p class="fw-500 word-break px-1 px-lg-2">파트너 소통 <span class="fw-600">3</span>C* 간담회 실시</p>
                                    </b-col>
                            ...
                            <b-col class="col-12 col-md-5 position-relative pl-md-4">
                                ...
                                <h7 class="gold7 mb-45 w-100">Performance</h7>                                    
                                    <p class="fw-500 line-height-low f-130 word-break">코로나<span class="fw-600">19</span> 특별재난지역 파트너 긴급생활비 지원</p>
                                    <p class="fw-500 line-height-low f-130 word-break"><span class="fw-600">3</span>C 간담회 기반 <span class="fw-600">9</span>개 유형의 VOC 개선</p>
                            </b-col>                            
                        </b-row>
                    </div>
                </section> 
