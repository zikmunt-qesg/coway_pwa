...
<div class="position-relative page-top-bg min-vh-100">  
    ...
    <b-container class="">
        <b-row class="my-5 pt-md-3">
            <h1 class="mt-2 mt-lg-5 mb-3 text-center text-white w-100 fw-400">MATERIAL TOPICS</h1>
            <p class="mb-0 mb-lg-4 text-center text-white w-100"> dummy text 환경을 건강하게 사람을 행복하게, 내일을 디자인하는 그린 글로벌 리더 </p>
        </b-row>
        <b-row class="px-lg-3">
            ...
            <b-container class="px-0">
                <section class="bg-blue1 px-4 py-4 mb-5">                    
                    ...
                    <b-row no-gutters class="px-3 pb-4 mb-5 mb-sm-0">
                        <b-col class="col-12 col-sm-4 blue8 fw-500">
                            <b-row no-gutters class="pr-sm-4">
                                ...
                                <b-col class="col-12 pt-3">
                                    ...
                                    <div class="text-center mb-2">
                                        ...
                                        <p class="gray65 mb-0"><span class="fw-600">2019</span>년 연구개발비</p>
                                        <p class="mb-0"><span class="f-230">37,671</span>백만 원</p>
                        ...
                        <b-col class="col-12 col-sm-8 pr-2 position-relative pl-md-5">
                        <div class="position-absolute vertical-line-1 d-none d-sm-block"></div>
                ...
                <div class="d-flex mb-3 position-relative"> <h6-ancor :title="'본질적 가치를 높이는 제품 혁신'" :activated="activated" class="blue7 f-130 fw-500 bg-white pr-5" style="z-index:10">본질적 가치를 높이는 제품 혁신 </h6-ancor><div class="horizontal-line-2 blue-line position-absolute" style="z-index:8"></div></div>
                    ...
                    <b-row class="mb-5">
                        <b-col class="col-12 col-sm-5 temp-img1 pr-0"><b-img src="@/assets/images/사각형 15@3x.png" fluid class="h-100"></b-img></b-col>
                        <b-col class="col-12 col-sm-7 px-0" style="left: -15px;"><h6-ancor :title="'혁신 기술의 집약, 한뼘 시루직수 정수기 개발 '" :activated="activated" class="blue5 mb-3 f-110">혁신 기술의 집약, 한뼘 시루직수 정수기 개발</h6-ancor>
                ...
                <section class="border-blue px-4 py-4 mb-5">
                    ...
                    <p class="mb-3">코웨이은 2020년 CES(Consumer Electronics Show)*에 참가하여 혁신적인 생활가전 제품 및 서비스를 전 세계에 선보였으며, 5년연속 CES 혁신상을 수상하며 혁신성을 인정받고 있습니다.
                    </p>
                    ...
                    <b-row class="mb-45">
                        <b-col class="col-12 col-sm-6" style="height:250px"><b-img src="@/assets/images/사각형 66@2x.png" fluid class="h-100"></b-img>
                ...
                <h6-ancor :title="'고객 맞춤형 혁신 다각화'" :activated="activated" class="blue5 mb-3 f-110">고객 맞춤형 혁신 다각화 </h6-ancor>
                <b-row class="mb-5">
                    <b-col class="col-12 col-sm-6">
                        <p class="mb-3"> 코웨이는 다양한 생활환경에 맞는 맞춤형 제품을 개발하여 고객 라이프스타일을 혁신합니다. 2019년 코웨이는 공기청정치 제품군을 시작으로 맞춤형 제품을 개발하고 있습니다. 거주 공간에서의 삶의 질을 추구하는 소비자의 증가에 따라 각 주거 환경에 맞춰 사용 가능한 벽걸이 겸용 제품 (AP-1519B, AP3519A), 디자인 가구형 공기청정기(AP-1019D)를 개발하여 자신만의 공간 구축에 대한 고객의 니즈를 반영했습니다. 또한 최근 국내외 시장에서 비대면 서비스에 대한 니즈가 커지고 있다는 점에 착안해 필터교체 알림을 통해 사용자 스스로 필터 세척 및 교체를 손쉽게 할 수 있는 자가관리형 공기청정기 카트리지(AP-1019C)를 개발하였습니다.
                        </p>
                ...
                <p class="mb-5">2019년 기준 국내 렌탈 서비스 569만명의 고객 계정을 보유하며 환경가전 업계를 선도하는 코웨이는 미래기술을 기반으로 고객에 새로운 서비스 경험을 제공합니다. 빅데이터를 이용하여 지역 수질에 맞는 정수기 제품을 추천하는 워터맵 서비스와, 가상 시뮬레이션을 통해 생활환경에 맞는 공기청정기를 체험해 볼 수 있는 공기주치의 서비스가 대표적입니다. 코웨이는 오랜 기간 연구해온 데이터를 기반으로 보다 정확하고 편리한 경험을 제공합니다.
                    ...
                    <h6-ancor :title="'빅데이터 기반 제품 추천, 워터맵 서비스'" :activated="activated" class="blue5 mb-3 f-110">빅데이터 기반 제품 추천, 워터맵 서비스</h6-ancor>
                ...
                <section class="bg-blue-gray1 py-4 px-4">
                    <b-row class="mb-45">
                        <b-col class="col-8"><b-img src="@/assets/images/사각형 19@3x.png" fluid class="w-100"></b-img> <div class="f-80 mt-2">코웨이 글로벌 워터맵</div></b-col>
                        <b-col class="col-4"><b-img src="@/assets/images/사각형 22@3x.png" fluid class="w-100"></b-img> <div class="f-80 mt-2">국내 워터맵</div></b-col>
                    </b-row>
                ...
                <hr class="space-p45">
                <h6-ancor :title="'시뮬레이션 체험, 공기 주치의 서비스 '" :activated="activated" class="blue5 mb-3 f-110">시뮬레이션 체험, 공기 주치의 서비스</h6-ancor>
                    ...
                    <b-row class="mb-5">
                        <b-col class="col-12 col-sm-4 "><b-img src="@/assets/images/48@3x.png" fluid class="w-100"></b-img></b-col>
                        <b-col class="col-12 col-sm-8 " style="left: -15px;"><h6-ancor :title="'모바일 서비스 강화, 안심 QR 서비스 시행'" :activated="activated" class="blue5 mb-3 f-110">모바일 서비스 강화, 안심 QR 서비스 시행</h6-ancor>
                ...
                <h6-ancor :title="'깨끗하고 맛있는 물에 대한 연구, 물맛 연구소'" :activated="activated" class="blue5 mb-3 f-110">깨끗하고 맛있는 물에 대한 연구, 물맛 연구소</h6-ancor>
                    ...
                    <b-row class="mb-5">
                        <b-col class="col-6"><b-img src="@/assets/images/27@3x.png" fluid class="w-100"></b-img> </b-col>
                        <b-col class="col-6"><b-img src="@/assets/images/30@3x.png" fluid class="w-100"></b-img> <div class="f-80 mt-2 gray6">http://water.coway.co.kr</div></b-col>
                    </b-row>
                    <b-row class="mb-5">
                        <b-col class="col-6">
                        <h6-ancor :title="'오픈 이노베이션, 아마존과 협력을 통한 IoT 기술 도입'" :activated="activated" class="blue5 mb-3 f-110">오픈 이노베이션, 아마존과 협력을 통한 IoT 기술 도입</h6-ancor>
                            ...
                            <p class="mb-3"> 2020년 5월 현재 코웨이와 아마존은 DART* 서비스가 적용된 공기청정기 기술을 적용하여 필터 수명 및 제품상태 확인, 음성명령을 통한 필터 주문을 구현하고 있습니다. 또한 2020년 내 코웨이의 정수기 제품 아쿠아메가(Aquamega)에도 알렉사를 적용하여 사용성을 제고할 계획입니다.
                            </p>
                        ...
                        <b-col class="col-6">
                            <div class="text-center"><b-img src="@/assets/images/33@3x.png" fluid style="width: 70%;"></b-img></div>
                            <b-img src="@/assets/images/9_1@3x.png" fluid class="w-100"></b-img> 
                        </b-col>
                    </b-row>
