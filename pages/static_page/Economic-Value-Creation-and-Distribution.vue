        ...
        <b-row>
            ...
            <b-container class="px-0">
                <section class="bg-white px-4 py-4">
                    ...
                    <h6-ancor hash="s1-1" :activated="activated" class="parang6 fw-500 mb-2">해외 사업의 꾸준한 확대</h6-ancor>
                    ...
                    <h6-ancor hash="s1-2" :activated="activated" class="parang6 fw-500 mb-2">넷마블 인수에 따른 구독경제 시너지 확대</h6-ancor>
                    ...
                    <div class="d-flex mb-3 position-relative overflow-hidden"> <h6-ancor hash="s2" :activated="activated" class="parang7 f-130 fw-500 bg-white pr-5" style="z-index:10">경제적 가치 분배</h6-ancor><div class="horizontal-line-2 parang-line position-absolute" style="z-index:8"></div></div>
                    ...
                    <div class="d-flex mb-3 position-relative overflow-hidden"> <h6-ancor hash="s3" :activated="activated" class="parang7 f-130 fw-500 bg-white pr-5" style="z-index:10">조세 정책</h6-ancor><div class="horizontal-line-2 parang-line position-absolute" style="z-index:8"></div></div>
                    ...
                    <h6-ancor hash="s3-1" :activated="activated" class="parang6 fw-500 mb-3">조세 납부 현황 및 유효세율 보고</h6-ancor>
