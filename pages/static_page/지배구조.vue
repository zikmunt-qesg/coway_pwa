...
<div class="position-relative page-top-bg-sus min-vh-100">   
    ...
    <div class="w-100 position-absolute bg-white" style="height:94.6%; top:600px; z-index:0"></div>
        ...
        <b-row>
            ...
            <b-container class="px-0">
                <section class="bg-white px-4 py-4">
                    ...
                    <h4-ancor :title="'지배구조'" :activated="activated" class="parang8 mb-4 mb-sm-5">지배구조</h4-ancor>
                    ...
                    <h6-ancor :title="'이사회 구성 현황'" :activated="activated" class="parang6 fw-500 mb-4">이사회 구성 현황</h6-ancor>
                    ...
                    <h6-ancor :title="'이사회의 독립성 및 전문성'" :activated="activated" class="parang6 fw-500 mb-3">이사회의 독립성 및 전문성</h6-ancor>
