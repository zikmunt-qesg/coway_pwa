                ...
                <section class="bg-white px-4 py-4 mb-5">
                    ...
                    <div style="border-bottom: 1.2px solid #6095dd;"> </div>
                        <b-table-simple responsive class="txt-table sustainability-table f-85 mb-5">
                            ...
                            <b-tbody>
                                <b-tr>
                                    <b-td class="text-center">1</b-td><b-td class="parang8"><span class="fw-400">Development of customized products and services</span></b-td><b-td> <nuxt-link :to="{path: '/static_page/Product-and-Service-Innovation', query: { l: 'ENG'}}" class="" id="content-links"> Product and Service Innovation <i class="fas fa-link fw-300 ml-2 f-80 gray4"></i></nuxt-link> </b-td><b-td class="f-80 parang6 text-center">&bigcirc;</b-td><b-td class="f-80 parang6 text-center">&bigcirc;</b-td><b-td></b-td>
                                </b-tr>
                                <b-tr>
                                    <b-td class="text-center">2</b-td><b-td class="parang8"><span class="fw-400">Reinforcement of product safety and reliability</span></b-td><b-td> <nuxt-link :to="{path: '/static_page/Product-Responsibility', query: { l: 'ENG'}}" class="" id="content-links"> Product Responsibility<i class="fas fa-link fw-300 ml-2 f-80 gray4"></i></nuxt-link> </b-td><b-td class="f-80 parang6 text-center">&bigcirc;</b-td><b-td></b-td><b-td class="f-80 parang6 text-center">&bigcirc;</b-td>
                                </b-tr>
                                <b-tr>
                                    <b-td class="text-center">3</b-td><b-td class="parang8"><span class="fw-400">Information Protection </span></b-td><b-td> <nuxt-link :to="{path: '/static_page/Information-Security-and-Personal-Information-Protection', query: { l: 'ENG'}}" class="" id="content-links"> Information Security and Personal Information Protection <i class="fas fa-link fw-300 ml-2 f-80 gray4"></i></nuxt-link> </b-td><b-td class="f-80 parang6 text-center">&bigcirc;</b-td><b-td class="f-80 parang6 text-center">&bigcirc;</b-td><b-td></b-td>
                                </b-tr>
                                <b-tr>
                                    <b-td class="text-center">4</b-td><b-td class="parang6"><span class="fw-400">Securing technical competitiveness by strengthening R&amp;D</span></b-td><b-td> <nuxt-link :to="{path: '/static_page/Product-and-Service-Innovation', query: { l: 'ENG'}}" class="" id="content-links"> Product and Service Innovation <i class="fas fa-link fw-300 ml-2 f-80 gray4"></i></nuxt-link> </b-td><b-td class="f-80 parang6 text-center">&bigcirc;</b-td><b-td></b-td><b-td class="f-80 parang6 text-center">&bigcirc;</b-td>
                                </b-tr>
                                <b-tr>
                                    <b-td class="text-center">5</b-td><b-td class="parang6"><span class="fw-400">Employee competency development and maintenance</span></b-td><b-td> <nuxt-link :to="{path: '/static_page/Employee-Centered-Company-Culture-and-Safe-Working-Environment#r1', query: { l: 'ENG'}}"  class="" id="content-links"> Employee-Oriented Culture, Safe and Healthy Workplace - Systematic Empowerment <i class="fas fa-link fw-300 ml-2 f-80 gray4"></i></nuxt-link> </b-td><b-td class="f-80 parang6 text-center">&bigcirc;</b-td><b-td class="f-80 parang6 text-center">&bigcirc;</b-td><b-td></b-td>
                                </b-tr>
                                <b-tr>
                                    <b-td class="text-center">6</b-td><b-td class="parang6"><span class="fw-400">Development of eco-friendly products and services</span></b-td><b-td> <nuxt-link :to="{path: '/static_page/Eco-Friendly-Product-Development-and-Product-Life-Cycle-Management', query: { l: 'ENG'}}" class="" id="content-links"> Eco-friendly Product Development and Life Cycle Management <i class="fas fa-link fw-300 ml-2 f-80 gray4"></i></nuxt-link> </b-td><b-td class="f-80 parang6 text-center">&bigcirc;</b-td><b-td class="f-80 parang6 text-center">&bigcirc;</b-td><b-td></b-td>
                                </b-tr>
                                <b-tr>
                                    <b-td class="text-center">7</b-td><b-td class="parang6"><span class="fw-400">Strategic social contribution activity</span></b-td><b-td> <nuxt-link  :to="{path: '/static_page/Local-Community', query: { l: 'ENG'}}" class="" id="content-links"> Local Community <i class="fas fa-link fw-300 ml-2 f-80 gray4"></i></nuxt-link> </b-td><b-td class="f-80 parang6 text-center">&bigcirc;</b-td><b-td></b-td><b-td></b-td>
                                </b-tr>
                                <b-tr>
                                    <b-td class="text-center">8</b-td><b-td class="parang6"><span class="fw-400">Compliance with human rights and labor principles</span></b-td><b-td> <nuxt-link :to="{path: '/static_page/Human-Rights-Report', query: { l: 'ENG'}}" class="" id="content-links"> Human Rights Report <i class="fas fa-link fw-300 ml-2 f-80 gray4"></i></nuxt-link> </b-td><b-td class="f-80 parang6 text-center">&bigcirc;</b-td><b-td></b-td><b-td class="f-80 parang6 text-center">&bigcirc;</b-td>
                                </b-tr>
                                <b-tr>
                                    <b-td class="text-center">9</b-td><b-td class="parang6"><span class="fw-400">Reinforcement of brand trust</span></b-td><b-td> <nuxt-link :to="{path: '/static_page/Product-and-Service-Innovation', query: { l: 'ENG'}}" class="" id="content-links"> Product and Service Innovation <i class="fas fa-link fw-300 ml-2 f-80 gray4"></i></nuxt-link> </b-td><b-td></b-td><b-td class="f-80 parang6 text-center">&bigcirc;</b-td><b-td class="f-80 parang6 text-center">&bigcirc;</b-td>
                                </b-tr>
                                <b-tr>
                                    <b-td class="text-center">10</b-td><b-td class="parang6"><span class="fw-400">Resource circulation and recycling</span></b-td><b-td> <nuxt-link :to="{path: '/static_page/Eco-Friendly-Product-Development-and-Product-Life-Cycle-Management#m2', query: { l: 'ENG'}}" class="" id="content-links"> Eco-Friendly Product Development and Life Cycle Management - Resource Efficiency and Circular Economy <i class="fas fa-link fw-300 ml-2 f-80 gray4"></i></nuxt-link> </b-td><b-td class="f-80 parang6 text-center">&bigcirc;</b-td><b-td></b-td><b-td class="f-80 parang6 text-center">&bigcirc;</b-td>
                                </b-tr>
                            </b-tbody>
                        </b-table-simple> 
                    <hr class="py-3">
