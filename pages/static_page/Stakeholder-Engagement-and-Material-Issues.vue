        ...
        <b-row>
            ...
            <b-container class="px-0">
                <section class="bg-white px-4 py-4">
                    ...
                    <h6-ancor hash="e1" :activated="activated" class="parang7 f-130 fw-500 bg-white" style="z-index:10">이해관계자 참여</h6-ancor>
                    ...
                    <div class="d-flex mb-3 position-relative overflow-hidden"> <h6-ancor hash="e2" :activated="activated" class="parang7 f-130 fw-500 bg-white pr-5" style="z-index:10">중대성 평가</h6-ancor><div class="horizontal-line-2 parang-line position-absolute" style="z-index:8"></div></div>
                    ...
                    <hr class="py-1">
                    <h6-ancor hash="e2-1" :activated="activated" class="parang6 mb-3 font-noto">Step 1. 이슈 풀(Pool)구성</h6-ancor>
                        ...
                        <b-col class="col-12 col-sm-6">
                            ...
                            <div class="px-md-3 py-3 border-bottom-dark adjust-height-80">
                                ...
                                <ul class="custom-ul line-height-low fw-300 f-90">
                                    ...
                                    <li>UN SDGs (UN Sustainable Development Goals)</li>
                                    <li>ISO26000</li>
                                    <li class="mb-1">DJSI (Dow Jones Sustainability Indices)</li>
                                </ul>
                            </div>
                        </b-col>
                        <b-col class="col-12 col-sm-6 position-relative">
                            ...
                            <div class="px-md-3 py-3 border-bottom-dark adjust-height-80">
                                ...
                                <ul class="custom-ul line-height-low fw-300 f-90 mb-3">
                                    ...
                                    <li>매체: 전국 14개 주요 일간지 포함 132개 언론사</li>
                                </ul>
                                <p class="parang6 fw-400 line-height-low"> 대외 커뮤니케이션 자료 주요 키워드 분석
                                </p>
                                <ul class="custom-ul line-height-low fw-300 f-90">
                                    <li>IR자료 및 실적발표자료 등</li>
                                </ul>
                            </div>
                        </b-col>
                    </b-row>
                    <hr class="py-2">
                    <h6-ancor hash="e2-2" :activated="activated" class="parang6 mb-3 font-noto">Step 2. 중대성 평가 실시</h6-ancor>
                    ...
                    <h7 class="mb-3 gray63">연관성 분석 - 기업 내부적 &amp; 산업적 맥락</h7>
                    <b-row class="mb-3">
                        <b-col class="col-12 col-sm-6">
                            ...
                            <div class="px-md-3 py-3 border-bottom-dark adjust-height-80">
                                ...
                                <ul class="custom-ul fw-300 f-90 mb-45">
                                    ...
                                    <li>지속가능경영 관련 전략 및 정책 문서 확인</li>
                                    <li>지속가능경영 추진 중장기 목표 및 성과 분석</li>
                                </ul>
                            </div>
                        </b-col>
                        <b-col class="col-12 col-sm-6 position-relative">
                            ...
                            <div class="px-md-3 py-3 border-bottom-dark adjust-height-80">
                                ...
                                <ul class="custom-ul line-height-low fw-300 f-90">
                                    ...
                                    <li>DJSI (Dow Jones Sustainability Indices) Household Durables 산업 평가 요건 분석</li>                            
                                    <li>MSCI Household Durables 산업 평가요건 분석 등</li>
                                </ul>
                            </div>
                        </b-col>
                    </b-row>
                    ...
                    <div class="px-md-3 py-4 border-bottom-dark mb-5">
                        ...
                        <ul class="custom-ul line-height-low fw-300 f-90">
                            ...
                            <li>기간: 2020.03.16~2020.03.23</li>                            
                            <li>조사방법: 온라인 설문조사</li>
                            <li>설문내용: 중요 이슈 선정, 이슈 우선순위 평가, 이슈 선정 맥락 조사</li>
                        </ul>
                    </div>
                    <hr class="py-2">

                    <h6-ancor hash="e2-3" :activated="activated" class="parang6 mb-3 font-noto">Step 3. 중요 주제 보고</h6-ancor>
                    ...
                    <div style="border-bottom: 1.2px solid #6095dd;"> </div>
                        <b-table-simple responsive class="txt-table sustainability-table f-95 mb-5">
                            ...
                            <b-tbody>
                                <b-tr>
                                    <b-td class="text-center">1</b-td><b-td class="parang8"><span class="fw-400">고객 맞춤형 제품 및 서비스 개발</span></b-td><b-td> <nuxt-link to="/static_page/Product-and-Service-Innovation" target="_blank"> 제품과 서비스의 혁신 <i class="fas fa-link fw-300 ml-2 f-80 gray4"></i></nuxt-link> </b-td><b-td class="f-80 parang6 text-center">●</b-td><b-td class="f-80 parang6 text-center">●</b-td><b-td></b-td>
                                </b-tr>
                                <b-tr>
                                    <b-td class="text-center">2</b-td><b-td class="parang8"><span class="fw-400">제품 안전 및 신뢰성 강화</span></b-td><b-td> <nuxt-link to="/static_page/Product-Responsibility" target="_blank"> 제품 책임 <i class="fas fa-link fw-300 ml-2 f-80 gray4"></i></nuxt-link> </b-td><b-td class="f-80 parang6 text-center">●</b-td><b-td></b-td><b-td class="f-80 parang6 text-center">●</b-td>
                                </b-tr>
                                <b-tr>
                                    <b-td class="text-center">3</b-td><b-td class="parang8"><span class="fw-400">정보보호</span></b-td><b-td> <nuxt-link to="/static_page/Information-Security-and-Personal-Information-Protection" target="_blank"> 정보보안 및 개인정보보호 <i class="fas fa-link fw-300 ml-2 f-80 gray4"></i></nuxt-link> </b-td><b-td class="f-80 parang6 text-center">●</b-td><b-td class="f-80 parang6 text-center">●</b-td><b-td></b-td>
                                </b-tr>
                                <b-tr>
                                    <b-td class="text-center">4</b-td><b-td class="parang6"><span class="fw-400">R&amp;D를 통한 기술 경쟁력 확보</span></b-td><b-td> <nuxt-link to="/static_page/Product-and-Service-Innovation" target="_blank"> 제품과 서비스의 혁신 <i class="fas fa-link fw-300 ml-2 f-80 gray4"></i></nuxt-link> </b-td><b-td class="f-80 parang6 text-center">●</b-td><b-td></b-td><b-td class="f-80 parang6 text-center">●</b-td>
                                </b-tr>
                                <b-tr>
                                    <b-td class="text-center">5</b-td><b-td class="parang6"><span class="fw-400">임직원 역량개발 및 유지</span></b-td><b-td> <nuxt-link to="/static_page/Employee-Centered-Company-Culture-and-Safe-Working-Environment#s1" target="_blank"> 임직원 중심의 기업문화와 안전한 근무환경 - 체계적인 역량 강화 <i class="fas fa-link fw-300 ml-2 f-80 gray4"></i></nuxt-link> </b-td><b-td class="f-80 parang6 text-center">●</b-td><b-td class="f-80 parang6 text-center">●</b-td><b-td></b-td>
                                </b-tr>
                                <b-tr>
                                    <b-td class="text-center">6</b-td><b-td class="parang6"><span class="fw-400">환경 친화적 제품 및 서비스 개발</span></b-td><b-td> <nuxt-link to="/static_page/Eco-Friendly-Product-Development-and-Product-Life-Cycle-Management" target="_blank"> 친환경 제품 개발과 제품 전 과정 관리 <i class="fas fa-link fw-300 ml-2 f-80 gray4"></i></nuxt-link> </b-td><b-td class="f-80 parang6 text-center">●</b-td><b-td class="f-80 parang6 text-center">●</b-td><b-td></b-td>
                                </b-tr>
                                <b-tr>
                                    <b-td class="text-center">7</b-td><b-td class="parang6"><span class="fw-400">전략적 사회공헌 활동</span></b-td><b-td> <nuxt-link to="/static_page/Local-Community" target="_blank"> 지역사회 <i class="fas fa-link fw-300 ml-2 f-80 gray4"></i></nuxt-link> </b-td><b-td class="f-80 parang6 text-center">●</b-td><b-td></b-td><b-td></b-td>
                                </b-tr>
                                <b-tr>
                                    <b-td class="text-center">8</b-td><b-td class="parang6"><span class="fw-400">인권과 노동 관련 원칙 준수</span></b-td><b-td> <nuxt-link to="/static_page/Human-Rights-Report" target="_blank"> 인권 리포트 <i class="fas fa-link fw-300 ml-2 f-80 gray4"></i></nuxt-link> </b-td><b-td class="f-80 parang6 text-center">●</b-td><b-td></b-td><b-td class="f-80 parang6 text-center">●</b-td>
                                </b-tr>
                                <b-tr>
                                    <b-td class="text-center">9</b-td><b-td class="parang6"><span class="fw-400">브랜드 신뢰도 강화</span></b-td><b-td> <nuxt-link to="/static_page/Product-and-Service-Innovation" target="_blank"> 제품과 서비스의 혁신 <i class="fas fa-link fw-300 ml-2 f-80 gray4"></i></nuxt-link> </b-td><b-td></b-td><b-td class="f-80 parang6 text-center">●</b-td><b-td class="f-80 parang6 text-center">●</b-td>
                                </b-tr>
                                <b-tr>
                                    <b-td class="text-center">10</b-td><b-td class="parang6"><span class="fw-400">자원순환 및 재활용</span></b-td><b-td> <nuxt-link to="/static_page/Eco-Friendly-Product-Development-and-Product-Life-Cycle-Management#s2" target="_blank"> 친환경 제품 개발과 제품 전 과정 관리 - 자원효율성 향상과 순환경제 지원 <i class="fas fa-link fw-300 ml-2 f-80 gray4"></i></nuxt-link> </b-td><b-td class="f-80 parang6 text-center">●</b-td><b-td></b-td><b-td class="f-80 parang6 text-center">●</b-td>
                                </b-tr>
                            </b-tbody>
                        </b-table-simple> 
                    <hr class="py-3">
                    
                    <div class="d-flex mb-4 position-relative overflow-hidden"> <h6-ancor hash="e3" :activated="activated" class="parang7 f-130 fw-500 bg-white pr-5" style="z-index:10">중대성 맥락과 중장기 목표</h6-ancor><div class="horizontal-line-2 parang-line position-absolute" style="z-index:8"></div></div>

                    <h6-ancor hash="e3-1" :activated="activated" class="parang6 mb-3 pb-2">고객 맞춤형 제품 및 서비스 개발</h6-ancor>
                    <b-row no-gutters class="mb-4 border-bottom-dark pb-3">
                        <b-col class="col-12 col-md-5 pr-md-3 mb-3 mb-md-0">
                            ...
                            <ul class="custom-ul f-95 pt-2 fw-300">
                                ...
                                <li>빅데이터, 가상 시뮬레이션 등 미래 기술 기반의 혁신적 서비스 제공</li>
        ...
        <b-row>
            ...
            <b-container class="px-0 eng-font-scale">
                <section class="bg-white px-4 py-4 mb-5">
                    ...
                    <!-- <hr class=""> -->
                        <h7 class="mb-3 gray63">Stakeholder Communication Channels</h7>
                        <b-table-simple responsive class="sep-table f-90 mb-5">
                            <b-tbody><b-tr class="bg-parang7 fw-300 text-white">
                                <b-td class="border-0 py-0" style="width: 15%">Stakeholder</b-td><b-td class="border-0 py-0" style="width: 38%">Communication Channel</b-td><b-td class="border-0 py-0" style="width: 17%">Communication Frequency</b-td><b-td class="border-0 py-0">Major Interest</b-td>
                            </b-tr>
                                <b-tr>
                                    <b-td rowspan="3" style="width: 15%">Customers<br><b-img src="/images/2_1.svg" class="mt-2"></b-img></b-td><b-td style="width: 38%">Company Website</b-td><b-td style="width: 17%">Frequently</b-td><b-td rowspan="3" class="custom-ul-li table-li"><ul><li>Product safety and quality responsibility</li><li>Thorough privacy protection</li><li>Product and service experience and experience</li><li>Immediate resolution of customer complaints</li></ul></b-td>
                                </b-tr>
                                <b-tr>
                                    <b-td>Media and News</b-td><b-td>Frequently</b-td>
                                </b-tr>
                                <b-tr class="border-bottom">
                                    <b-td>VOC/ Call Center</b-td><b-td>Frequently</b-td>
                                </b-tr>
                                ...
                                <b-tr>
                                    <b-td>Partner Meeting</b-td><b-td>Frequently</b-td>
                                </b-tr>
                    ...
                    <div class="d-flex mb-3 position-relative overflow-hidden"> <h6-ancor hash="e2" :activated="activated" class="parang7 f-130 fw-500 bg-white pr-5" style="z-index:10">Materiality Assessment</h6-ancor><div class="horizontal-line-2 parang-line position-absolute" style="z-index:8"></div></div>
                    ...
                    <b-row class="mb-5">
                        <b-col class="col-12 col-sm-6">
                            <div class="py-3 px-3 parang8-box parang8 text-center fw-500">Global Sustainability Standards and Initiatives</div>
                            <div class="px-md-3 py-3 border-bottom-dark adjust-height-80">
                                <p class="parang6 fw-400 pt-2 pb-1 line-height-low"> Information disclosure requirements of sustainability management reporting standards, reflect global sustainability standards and initiatives major issues
                                </p>
                                <ul class="custom-ul line-height-low fw-300 f-90">
                                    <li>GRI (Global Reporting Initiative) Standards</li>
                                    <li>SASB (Sustainability Accounting Standards Board)</li>
                    ...
                    <h7 class="mb-3 gray63">Relevance Analysis – Corporate Internal &amp; Industrial Context</h7>
                    <b-row class="mb-3">
                        <b-col class="col-12 col-sm-6">
                            <div class="py-3 px-3 parang8-box parang8 text-center fw-500">Internal Relevance</div>
                            <div class="px-md-3 py-3 border-bottom-dark adjust-height-80">
                                <p class="parang6 fw-400 pt-1 pb-1 line-height-low"> Identify internal major issues based on Coway's sustainability management strategy, policy and status analysis
                                </p>
                                <ul class="custom-ul fw-300 f-90 mb-45">
                                    <li>Review Last year's report on sustainability management</li>
                                    <li>Check the strategy and policy documents related to sustainability management</li>
                                    <li>Mid- to long-term sustainable management goal and performance analysis for sustainable management</li>
                                </ul>
                            </div>
                        </b-col>
                        <b-col class="col-12 col-sm-6 position-relative">
                            <div class="vertical-line-dotted position-absolute d-none d-sm-block" style="height: 76%; top: 17%;"></div>
                            <div class="py-3 px-3 parang8-box parang8 text-center fw-500">Industrial Relevance</div>
                            <div class="px-md-3 py-3 border-bottom-dark adjust-height-80">
                                <p class="parang6 fw-400 pt-1 pb-1 line-height-low"> 
                                    In-depth issues and context review of corporate reports of other companies in same industry and analysis of industry-specific evaluation indicators for global sustainability assessment
                                </p>
                                <ul class="custom-ul line-height-low fw-300 f-90 mb-3">
                                    <li>In-depth analysis of the report status and issues of 2 overseas companies and 3 domestic companies </li>
                                    <li>DJSI (Dow Jones Sustainability Indices) Household Durables industry evaluation requirements analysis </li>                            
                                    <li>MSCI Household Durables industry evaluation requirements analysis, etc.</li>
                                </ul>
                            </div>
                        </b-col>
                    </b-row>
                    <div class="py-3 px-3 parang8-box parang8 text-center fw-500">Impact Analysis – Stakeholder Survey</div>
                    <div class="px-md-3 py-4 border-bottom-dark mb-5">
                        <p class="parang6 fw-400 py-1 line-height-low"> Conduct online surveys to assess the level of impact, importance and response priorities for stakeholders on each issue
                        </p>
                        <ul class="custom-ul line-height-low fw-300 f-90">
                            <li>Target: 7 major stakeholders (customers, shareholders and investors, employees, partners, government, academia and media, and local communities)</li>
                            <li>Period: 2020.03.16~2020.03.23</li>                            
                            <li>Survey Method: Online Survey</li>
                            <li>Questionnaire: Selection of material topics, evaluation of priority of issues, context investigation of issue selection</li>
                        </ul>
                    </div>
                    <hr class="py-2">
                    ...
                    <div style="border-bottom: 1.2px solid #6095dd;"> </div>
                        <b-table-simple responsive class="txt-table sustainability-table f-85 mb-5">
                            <b-thead>
                                <b-tr>
                                    <b-td rowspan="2" class="text-center">No</b-td><b-td rowspan="2" class="text-center">Material Topics</b-td><b-td rowspan="2" class="text-center w-50">Report topic</b-td><b-td colspan="3" class="border-bottom-0 text-center">Business impact</b-td>
                                </b-tr>
                                <b-tr>
                                    <b-td class="text-center">Cost</b-td><b-td class="text-center">Revenue</b-td><b-td class="text-center">Risk</b-td>
                                </b-tr>
                            </b-thead>
                            <b-tbody>
                                <b-tr>
                                    <b-td class="text-center">1</b-td><b-td class="parang8"><span class="fw-400">Development of customized products and services</span></b-td><b-td> <nuxt-link to="/static_page/Product-and-Service-Innovation" class="" id="content-links" target="_blank"> Product and Service Innovation <i class="fas fa-link fw-300 ml-2 f-80 gray4"></i></nuxt-link> </b-td><b-td class="f-80 parang6 text-center">&bigcirc;</b-td><b-td class="f-80 parang6 text-center">&bigcirc;</b-td><b-td></b-td>
                                </b-tr>
                                <b-tr>
                                    <b-td class="text-center">2</b-td><b-td class="parang8"><span class="fw-400">Reinforcement of product safety and reliability</span></b-td><b-td> <nuxt-link to="/static_page/Product-Responsibility" class="" id="content-links" target="_blank"> Product Responsibility<i class="fas fa-link fw-300 ml-2 f-80 gray4"></i></nuxt-link> </b-td><b-td class="f-80 parang6 text-center">&bigcirc;</b-td><b-td></b-td><b-td class="f-80 parang6 text-center">&bigcirc;</b-td>
                                </b-tr>
                                <b-tr>
                                    <b-td class="text-center">3</b-td><b-td class="parang8"><span class="fw-400">Information Protection </span></b-td><b-td> <nuxt-link to="/static_page/Information-Security-and-Personal-Information-Protection" class="" id="content-links" target="_blank"> Information Security and Personal Information Protection <i class="fas fa-link fw-300 ml-2 f-80 gray4"></i></nuxt-link> </b-td><b-td class="f-80 parang6 text-center">&bigcirc;</b-td><b-td class="f-80 parang6 text-center">&bigcirc;</b-td><b-td></b-td>
                                </b-tr>
                                <b-tr>
                                    <b-td class="text-center">4</b-td><b-td class="parang6"><span class="fw-400">Securing technical competitiveness by strengthening R&amp;D</span></b-td><b-td> <nuxt-link to="/static_page/Product-and-Service-Innovation" class="" id="content-links" target="_blank"> Product and Service Innovation <i class="fas fa-link fw-300 ml-2 f-80 gray4"></i></nuxt-link> </b-td><b-td class="f-80 parang6 text-center">&bigcirc;</b-td><b-td></b-td><b-td class="f-80 parang6 text-center">&bigcirc;</b-td>
                                </b-tr>
                                <b-tr>
                                    <b-td class="text-center">5</b-td><b-td class="parang6"><span class="fw-400">Employee competency development and maintenance</span></b-td><b-td> <nuxt-link to="/static_page/Employee-Centered-Company-Culture-and-Safe-Working-Environment#r1" class="" id="content-links" target="_blank"> Employee Centered Company Culture and Safe Working Environment - Capacity Enhancement for Good Growth <i class="fas fa-link fw-300 ml-2 f-80 gray4"></i></nuxt-link> </b-td><b-td class="f-80 parang6 text-center">&bigcirc;</b-td><b-td class="f-80 parang6 text-center">&bigcirc;</b-td><b-td></b-td>
                                </b-tr>
                                <b-tr>
                                    <b-td class="text-center">6</b-td><b-td class="parang6"><span class="fw-400">Development of eco-friendly products and services</span></b-td><b-td> <nuxt-link to="/static_page/Eco-Friendly-Product-Development-and-Product-Life-Cycle-Management" class="" id="content-links" target="_blank"> Eco Friendly Product Development and Product Life Cycle Management <i class="fas fa-link fw-300 ml-2 f-80 gray4"></i></nuxt-link> </b-td><b-td class="f-80 parang6 text-center">&bigcirc;</b-td><b-td class="f-80 parang6 text-center">&bigcirc;</b-td><b-td></b-td>
                                </b-tr>
                                <b-tr>
                                    <b-td class="text-center">7</b-td><b-td class="parang6"><span class="fw-400">Strategic social contribution activity</span></b-td><b-td> <nuxt-link to="/static_page/Local-Community" class="" id="content-links" target="_blank"> Local Community <i class="fas fa-link fw-300 ml-2 f-80 gray4"></i></nuxt-link> </b-td><b-td class="f-80 parang6 text-center">&bigcirc;</b-td><b-td></b-td><b-td></b-td>
                                </b-tr>
                                <b-tr>
                                    <b-td class="text-center">8</b-td><b-td class="parang6"><span class="fw-400">Compliance with human rights and labor principles</span></b-td><b-td> <nuxt-link to="/static_page/Human-Rights-Report" class="" id="content-links" target="_blank"> Human Rights Report <i class="fas fa-link fw-300 ml-2 f-80 gray4"></i></nuxt-link> </b-td><b-td class="f-80 parang6 text-center">&bigcirc;</b-td><b-td></b-td><b-td class="f-80 parang6 text-center">&bigcirc;</b-td>
                                </b-tr>
                                <b-tr>
                                    <b-td class="text-center">9</b-td><b-td class="parang6"><span class="fw-400">Reinforcement of brand trust</span></b-td><b-td> <nuxt-link to="/static_page/Product-and-Service-Innovation" class="" id="content-links" target="_blank"> Product and Service Innovation <i class="fas fa-link fw-300 ml-2 f-80 gray4"></i></nuxt-link> </b-td><b-td></b-td><b-td class="f-80 parang6 text-center">&bigcirc;</b-td><b-td class="f-80 parang6 text-center">&bigcirc;</b-td>
                                </b-tr>
                                <b-tr>
                                    <b-td class="text-center">10</b-td><b-td class="parang6"><span class="fw-400">Resource circulation and recycling</span></b-td><b-td> <nuxt-link to="/static_page/Eco-Friendly-Product-Development-and-Product-Life-Cycle-Management#m2" class="" id="content-links" target="_blank"> Eco Friendly Product Development and Product Life Cycle Management - Improvement of Resource Efficiency and Support Circular Economy <i class="fas fa-link fw-300 ml-2 f-80 gray4"></i></nuxt-link> </b-td><b-td class="f-80 parang6 text-center">&bigcirc;</b-td><b-td></b-td><b-td class="f-80 parang6 text-center">&bigcirc;</b-td>
                                </b-tr>
                            </b-tbody>
                        </b-table-simple> 
                    <hr class="py-3">
                    ...
                    <b-row no-gutters class="mb-4 border-bottom-dark pb-3">
                        <b-col class="col-12 col-md-5 pr-md-3 mb-3 mb-md-0">
                            <div class="parang8-box py-1 fw-500 text-center mb-3" style="width:156px">Actvities</div>
                            <ul class="custom-ul f-90 pt-2 fw-300">
                                <li>Develop innovative products and services based on customer needs and lifestyle</li>
                                <li>Provide innovative services based on future technologies such as big data and virtual simulation</li>
                                <li>Reinforce customer value innovation capabilities through R&amp;D and open innovation</li>
                            </ul>
                        </b-col>
                        <b-col class="col-12 col-md-7 pl-md-4 position-relative">
                        <div class="vertical-line-dotted position-absolute d-none d-md-block"></div>
                            ...
                            <div class="pt-2">
                                ...
                                <ol type="1" class="f-80 fw-300 footnote-ol line-height-low ">
                                    <li> Customer satisfaction is measured through NPS (net recommendation index = recommended customer ratio-non-recommended customer ratio)
                                    </li>
                                    <li> In 2019, the survey method was changed to mobile.</li>
                                </ol>
                            </div>
                        </b-col>
                    </b-row>                   
                    ...
                    <b-row no-gutters class="mb-4 border-bottom-dark pb-3 pt-1">
                        <b-col class="col-12 col-md-5 pr-md-3 mb-3 mb-md-0">
                            <div class="parang8-box py-1 fw-500 text-center mb-3" style="width:156px">Actvities</div>
                            <ul class="custom-ul f-90 pt-2 fw-300">
                                <li>Product Responsibility Governance-Infinite Responsibility Committee, PIC 360, TQA Center </li>
                                <li>Reliability test standard development and verification capability enhancement </li>
                                <li>Increased safety certification and customer safety service</li>
                            </ul>
                        </b-col>
                        <b-col class="col-12 col-md-7 pl-md-4 position-relative">
                        <div class="vertical-line-dotted position-absolute d-none d-md-block"></div>
                    ...
                    <b-row no-gutters class="mb-4 border-bottom-dark pb-3">
                        <b-col class="col-12 col-md-5 pr-md-3 mb-3 mb-md-0">
                            <div class="parang8-box py-1 fw-500 text-center mb-3" style="width:156px">Actvities</div>
                            <ul class="custom-ul f-90 pt-2 fw-300">
                                <li>Thorough management based on information protection and personal information protection principles</li>
                                <li>Respond to global information protection regulations</li>
