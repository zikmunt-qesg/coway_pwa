    ...
    <b-container class="">
        ...
        <b-row>
            <b-col class="d-none d-lg-inline col-lg-3 side-nav">
                ...
                :sub_titles="['환경경영을 통한 깨끗함의 가치 실현', '전과정 수자원 사용량 절감', '가치사슬 전체의 환경역량 강화']"
                :activated="activated"
                ></side-navigation>
            </b-col>
            ...
            <b-container class="px-0">
                ...
                <section class="mb-5">
                    <h6-ancor :title="'환경경영을 통한 깨끗함의 가치 실현'" :activated="activated">환경경영을 통한 깨끗함의 가치 실현</h6-ancor>
                    ...
                    <hr class="space-p25">
                    <h6 class="fw-500 mb-3">환경경영 전략</h6>
                ...
                <section class="mb-5">
                    ...
                    <hr class="space-p25">    
                    <h6-ancor :title="'전과정 수자원 사용량 절감'" :activated="activated">전과정 수자원 사용량 절감</h6-ancor>
                ...
                <section class="mb-5">
                    <h6-ancor :title="'가치사슬 전체의 환경역량 강화'" :activated="activated">가치사슬 전체의 환경역량 강화</h6-ancor>
