...
<div class="position-relative page-top-bg min-vh-100">
    ...
    <b-container class="">
        <b-row class="my-5 pt-md-5">
            ...
            <p class="mb-lg-5 text-center w-100 f-95"> 환경을 건강하게 사람을 행복하게, 내일을 디자인하는 그린 글로벌 리더 </p>
        </b-row>
        <b-row>
            ...
            <b-container class="px-0">
                    ...
                    <div class="border-top-bottom-dark">
                        <b-row no-gutters class="py-4">
                            <b-col class="col-12 col-sm-6 mb-5 mb-sm-0 pr-sm-4 fw-500 green7">
                                ...
                                <h4-ancor :title="'깨끗한 물과 공기를 위한 환경경영'" :activated="activated" class="mb-4 mb-sm-5">깨끗한 물과 공기를 위한 환경경영</h4-ancor>
                            ...
                            <b-col class="col-12 col-sm-6 ">
                                ...
                                <h7 class="green6 mb-3">Business relevance & Approach</h7>
                                <p>고객에게 최종 전달되는 제품 뿐만 아니라 생산과정에서도 운영환경효율성을 갖추어야 합니다.
                                   코웨이는 유구공장, 인천공장, 포천공장 등 국내 공장에서 정수기 및 공기청정기를 연 XX 대 생산하는 생산 규모를 갖추고 있으며, 정수기 필터에 사용되는 프리 카본 필터나 포스트 카본 필터 등 관련 부품 또한 연간 XXX대를 생산합니다. 전국 배송을 위해 대형 물류센터 및 물류 네트워크 또한 운영합니다.
                        ...
                        <b-row no-gutters class="py-3 border-top-dark">
                            ...
                            <b-col class="col-6 col-md-3 text-center">
                                ...
                                <p>친환경 · 착한 <br>브랜드 정립</p>
                            </b-col>
                            <b-col class="col-6 col-md-3 text-center">
                                <div class="temp-icon2 mx-auto mb-3"><b-img src="@/assets/images/구성 요소10_1.svg" fluid class="h-100"></b-img> </div>
                                <p>에코 비즈니스<br>(Eco-Business) 구축</p>
                            </b-col>
                            <b-col class="col-6 col-md-3 text-center">
                                <div class="temp-icon2 mx-auto mb-3"><b-img src="@/assets/images/구성 요소10_1.svg" fluid class="h-100"></b-img> </div>
                                <p>친환경 가치사슬<br>구축 및 운영</p>
                            </b-col>
                            <b-col class="col-6 col-md-3 text-center">
                                <div class="temp-icon2 mx-auto mb-3"><b-img src="@/assets/images/구성 요소10_1.svg" fluid class="h-100"></b-img> </div>
                        ...
                        <b-row no-gutters class="py-3 border-top-dark">
                            ...
                            <b-col class="col-12 col-md-6">
                                <h7 class="green6 mb-3 w-100 pl-md-4">Performance</h7>
                                <b-row no-gutters class="pl-md-4 align-items-center position-relative"> 
                                    ...
                                    <b-col class="col-7">
                                        <p>2050년까지 <br>신재생에너지 RE100,<br>탄소 배출량 제로<br>NET ZERO 달성 </p>
                                        <p class="f-90 fw-300">(2030년 신재생 50%, <br> 2040년 75%, 2050년 100%)</p>
                                    </b-col>
                                    <b-col class="col-5"><div class="temp-icon3 mx-auto mb-3"><b-img src="@/assets/images/구성 요소15_1.svg" fluid class="w-100"></b-img></div></b-col>
                                </b-row>
                            </b-col>
                        </b-row>
                    </div>
                ...
                <section class="mb-5">
                    <h6-ancor :title="'환경경영을 통한 깨끗함의 가치 실현'" :activated="activated" class="fw-500 green7 mb-3">환경경영을 통한 깨끗함의 가치 실현</h6-ancor>
                        ...
                        <p> 코웨이는 비즈니스 운영과정에서의 환경영향을 최소화하고자 2006년부터 환경경영을 선포하면서 미션과 비전, 환경방침, 환경목표를 설정하고 환경경영위원회와 전담부서를 설치하여 전사적인 친환경 경영을 실천해 왔습니다. 2019년에는 기존 환경경영 전략에 의한 기후변화, 자원순환, 제품 친환경 설계를 계획대로 실천하며 소비자의 니즈와 사회적 요구사항을 반영하며 제품 안전성 강화에 집중하고 있습니다.
                        </p>
                    <hr class="space-p25">
                    <h6-ancor :title="'코웨이 환경경영 방침'" :activated="activated" class="fw-500 mb-45 f-105">코웨이 환경경영 방침</h6-ancor>
                        <div class="row force-deflex">
                            <div class="col">
                                <div class="temp-icon4 mb-3"></div>
                                <span class="f-87 border-bottom-dotted">친환경 비즈니스에 지속적인 투자와 혁신을 통해 코웨이 지속가능성 강화와 글로벌 친환경기업 리더십을 확보한다.
                                </span>
                            </div>
                            <div class="col">
                                <div class="temp-icon4 mb-3"></div>
                                <span class="f-87 border-bottom-dotted"> 환경법규를 준수하고 선진적인 환경경영시스템을 구축하여 지속적인 환경경영 가치 창출 및 미래성장 동력을 확보한다.
                                </span>
                            </div>
                            <div class="col">
                                <div class="temp-icon4 mb-3"></div>
                                <span class="f-87 border-bottom-dotted"> 청정생산 체계를 구축하여 환경오염물질 및 온실가스 배출 감축활동 등 사전 예방활동을 통해 환경부하를 최소화하고 후손에게 쾌적한 환경을 제공한다. 
                                </span>
                            </div>
                            <div class="col">
                                <div class="temp-icon4 mb-3"></div>
                                <span class="f-87 border-bottom-dotted"> 제품 및 서비스의 전과정에 걸쳐 환경성을 고려하여 녹색 제품, 서비스 및 기술 개발을 선도한다.
                                </span>
                            </div>
                            <div class="col">
                                <div class="temp-icon4 mb-3"></div>
                                <span class="f-87 border-bottom-dotted"> 이해관계자에게 환경경영 정보를 투명하게 공개하고 지속적인 커뮤니케이션을 수행하여 지역사회의 환경보전활동에 적극 참여한다.
                                </span>
                            </div>
                        </div>
                    <hr class="space-p25">
                    <h6-ancor :title="'환경경영 전략'" :activated="activated" class="green6 fw-500 mb-3 f-110">환경경영 전략</h6-ancor>
                ...
                <section class="bg-blue-gray1 px-6 py-5 mb-5 text-center">
                    <h5 class="fw-500 green7 mb-3">Green Up</h5>
                    <h6 class="fw-500 green7 mb-2 f-110">환경을 건강하게 사람을 행복하게</h6>
                    <div class="mb-4 bg-gray7" style="height:20px; width:3px; margin-left:50%;"></div>
                    <b-row class="mb-4">
                    ...
                    <div class="position-relative mb-4" style="height:45px;"> 
                    ...
                    <h6 class="fw-500 green7 mb-4 f-110">환경에 가치를 더하다</h6>
                    ...
                    <b-row class="border-top-bottom-dark bg-white py-4">
                        ...
                        <b-col class="col-6 col-sm-3 mb-3 mb-sm-0">
                            <div class="temp-icon5 mx-auto position-relative"><b-img src="@/assets/images/구성 요소19_1.svg" fluid class="w-100"></b-img></div>
                        </b-col>
                        <b-col class="col-6 col-sm-3 mb-3 mb-sm-0">
                            <div class="temp-icon5 mx-auto position-relative"><b-img src="@/assets/images/구성 요소20_1.svg" fluid class="w-100"></b-img></div>
                        </b-col>
                        <b-col class="col-6 col-sm-3 mb-3 mb-sm-0">
                            <div class="temp-icon5 mx-auto position-relative"><b-img src="@/assets/images/구성 요소17_1.svg" fluid class="w-100"></b-img></div>
                        </b-col>
                    </b-row>
                    <b-row class="py-3">
                        <b-col class="col-6 col-sm-3 mb-3 mb-sm-0">
                            <p class="mb-1 green6">REPUTATION</p>
                            <p class="mb-0">친환경 / 착한 브랜드 구축 및 극대화 </p>
                        </b-col>
                        <b-col class="col-6 col-sm-3 mb-3 mb-sm-0">
                            <p class="mb-1 green6">RISK TAKING</p>
                            <p class="mb-0">Eco-Biz 구축 및 향상 착한 선순환 수익 구조 확립 </p>
                        </b-col>
                        <b-col class="col-6 col-sm-3 mb-3 mb-sm-0">
                            <p class="mb-1 green6">REVENUE</p>
                            <p class="mb-0">Eco-Balue Chain 구축 / 운영 환경 안전 사전 예방</p>
                        </b-col>
                        <b-col class="col-6 col-sm-3 mb-3 mb-sm-0">
                            <p class="mb-1 green6">COMMUNICATION</p>
                ...
                <section class="mb-5">
                    <h6-ancor :title="'가치사슬 전체의 환경역량 강화'" :activated="activated" class="fw-500 green7 mb-3">가치사슬 전체의 환경역량 강화</h6-ancor>
                        <p> 코웨이는 지속 강화되어 가는 제품환경규제 및 안전성 대응을 위해 코웨이 전직원 및 협력사 대상으로 매년 오프라인 교육 프로그램을 제공 및 수시 온라인 지도, 지원을 실시하고 있습니다. “Global 환경규제 동향”, “기업의 환경규제 대응”, “환경규제 대응 방법론” 등 실질적이고 지속적인 도움을 제공함으로서 규제 대응력 강화 및 risk 제로 실행에 목표를 두고 있습니다. 2019년 사내 담당자 390명 및 협력사 77개사 담당자 대상으로 교육 실시를 완료하였습니다. 추가로 교육 내용 및 업무 활용에서 90%이상의 협력사로부터 우수하고 업무 적용 가능한 것으로 평가받았습니다.
                        </p>
                    <hr class="space-p25">
...
<style lang="scss">
/* .page-top-bg {
    background-image: url(../../assets/images/사각형17.png);
