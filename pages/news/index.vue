        ...
        <b-row>
            ...
            <b-col class="col-12 col-lg-10 bg-white px-md-4 px-lg-5">
                <section class="px-3 px-md-4 px-lg-5 py-4 py-lg-5">
                    <div class="d-flex mb-45 position-relative overflow-hidden"> <h4 class="parang7 fw-500 bg-white pr-4" style="z-index:10">{{is_ENG!==true?'지속가능경영 뉴스':'Sustainability News'}}</h4><div class="horizontal-line-2 parang-line position-absolute" style="z-index:8"></div></div>
