...
<div class="position-relative min-vh-100">
    <b-row no-gutters class="py-5 bg-blue3 mb-5">
        <b-col class="py-5 my-5 text-center text-white"><h1>Coway Sustainability News</h1></b-col>
    </b-row>
    <b-container>
        ...
        <b-table-simple responsive class="txt-table">
            ...
            <b-tbody v-for="(item, index) in articles" :Key="item.id">
                <b-tr>
                    ...
                    <b-td class="border-0">
                        <b-button v-b-toggle="'collapse'+`${index}`" block variant="icon" class="p-0 text-left">{{ item.title }}</b-button>
                    </b-td>
                    ...
                    <b-td colspan="5" class="p-0">
                         <b-collapse :id="'collapse'+`${index}`" class="mb-2">
                            <b-card class="border-dotted bg-gray1 gray6 py-md-2 px-md-3">
                                ...
                                <b-card-body class="border-0 bg-transparent fw-600">{{ item.description }}</b-card-body>
                                <b-card-body class="border-0 bg-transparent f-95 fw-300">{{ item.contents }}</b-card-body>
                                <div v-if="item.picture!=''" class="mt-3"><b-img src="item.picture"></b-img><span class="pl-3 f-80 gray6">{{ item.picture }}</span></div>
                            </b-card>
                        </b-collapse>      
                    </b-td>                
                </b-tr>
