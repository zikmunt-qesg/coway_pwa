...
<div>
    <transition name="show-fade" mode="out-in">
        <div v-if="isVisible" class="position-fixed text-center" style="right:0; top: calc(50vh - 180px)">
            ...
            <transition name="slide-fade" mode="out-in">  
                <div id="external-btns" v-if="is_opened==true" class="">             
                    <div class="d-flex flex-column justify-content-center">
                        <a href="http://www.coway.co.kr/" target="_blank" class="text-center"><b-img src="/images/109_1.svg" class="external-link-btn" ></b-img> </a>
                        <div class="short-divide-line"></div>
                        <a href="http://www.coway.co.kr/" target="_blank" class="text-center"><b-img src="/images/110_1.svg" class="external-link-btn pb-1"></b-img> </a>
                        <div class="short-divide-line"></div>
                        ...
                        <div class="short-divide-line"></div>
                        <a href="http://www.coway.co.kr/" target="_blank" class="text-center"><b-img src="/images/112_1.svg" class="external-link-btn"></b-img> </a>
                        <div class="short-divide-line"></div>
                        <div @click="backToTop" class="text-center cursor go-to-top pt-2"><b-img src="/images/113_1.svg" class=""></b-img> </div>
                    </div>            
                </div>
            </transition>
        </div>
